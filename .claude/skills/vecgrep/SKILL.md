---
name: vecgrep
description: Explain how to use vecgrep effectively for semantic search, indexing, filtering, TUI/server modes, and troubleshooting.
user_invocable: true
---
...
For concrete commands, read [`../../../skills/vecgrep/references/commands.md`](../../../skills/vecgrep/references/commands.md).
